...
<body class="vh-100">
    ...
    <div class="w-100 d-flex" style="height: 65vh;">
        ...
        <main class="text-justify border border-dark p-4 position-absolute top-70 end-0 overflow-y-scroll" style="width: 83%; height:65vh">
            ...
            <?php if (isset($_GET['d'])) : ?>
                <p class="position-relative bg-info p-3 border border-info text-success text-center" style="--bs-bg-opacity: .4;">Produk Berhasil Dihapus <a href="produkKami.php" class="position-absolute d-block text-decoration-none text-danger bg-light rounded-circle border border-danger top-0 start-100 translate-middle" style="width: 28px;height: 28px;--bs-bg-opacity: .7;">x</a></p>
            <?php endif; ?>
            <div class="m-2 shadow-lg p-3 rounded">
                <div class="d-flex justify-content-between align-items-center p-2">
                    <h4 class="mb-3">Semua Produk</h4>
                    <a href="produkTambah.php" class="btn btn-dark px-4">+</a>
                </div>
                        ...
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-around align-items-center gap-2">
                                    <a href="produkUbah.php?id=<?= $p['id'] ?>" class="btn btn-success">Ubah</a>
                                    <a href="../util/hapusProduk.php?id=<?= $p['id'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda ingin menghapus data ini?')">Hapus</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
